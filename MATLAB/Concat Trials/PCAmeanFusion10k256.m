...
featuresFused = pca(mean(cat(3, featuresTrainA, featuresTrainB, featuresTrainC), 3));
...
featuresTestFused = pca(mean(cat(3, featuresTestA, featuresTestV1, featuresTestV2), 3));
