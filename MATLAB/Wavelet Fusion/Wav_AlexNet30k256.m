...
imdsH = imageDatastore('/media/titan/Storage 1/WavH_256_ObjectCategories',...
    'IncludeSubfolders', true, ...
    'LabelSource', 'foldernames');

imdsV = imageDatastore('/media/titan/Storage 1/WavV_256_ObjectCategories',...
    'IncludeSubfolders', true, ...
    'LabelSource', 'foldernames');

imdsD = imageDatastore('/media/titan/Storage 1/WavD_256_ObjectCategories',...
    'IncludeSubfolders', true, ...
    'LabelSource', 'foldernames');
...
numImgs = 80;
imdsTrimmedH = splitEachLabel(imdsH, numImgs, 'randomized')
imdsTrimmedV = splitEachLabel(imdsV, numImgs, 'randomized');
imdsTrimmedD = splitEachLabel(imdsD, numImgs, 'randomized');
